...
```sh
helm pull oci://quay.io/reshapr/reshapr-helm-charts/reshapr-control-plane --version 0.0.1

helm install reshapr-control-plane oci://quay.io/reshapr/reshapr-helm-charts/reshapr-control-plane --version 0.0.1 \
...
```sh
helm pull oci://quay.io/reshapr/reshapr-helm-charts/reshapr-proxy --version 0.0.1

helm install reshapr-proxy oci://quay.io/reshapr/reshapr-helm-charts/reshapr-proxy --version 0.0.1 \
